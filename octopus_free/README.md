...
- [Octopus deploy](#octopus-deploy)
  ...
  - [Octopus server free](#octopus-server-free)
  - [Install Octopus Server](#install-octopus-server)
  - [Install Octopus as a Windows Service](#install-octopus-as-a-windows-service)
  - [Octopus deploy free edition](#octopus-deploy-free-edition)
  ...
  - [1.  First Deployment](#1--first-deployment)
    ...
    - [Create deployment process](#create-deployment-process)
      - [Execution Location](#execution-location)
    - [Release and deploy](#release-and-deploy)
    - [Execute deployment](#execute-deployment)
  - [2. Define and use variables](#2-define-and-use-variables)
    - [Update deployment processBookmark](#update-deployment-processbookmark)
  - [3. Approvals with Manual Interventions](#3-approvals-with-manual-interventions)
  - [4. Add deployment targets](#4-add-deployment-targets)
  - [5. Deploy a sample package](#5-deploy-a-sample-package)
    - [Add deploy package step](#add-deploy-package-step)
    - [Release and deploy](#release-and-deploy-1)
  - [Octopus in a nutshell](#octopus-in-a-nutshell)
  - [Tutrial Your First Runbook Run](#tutrial-your-first-runbook-run)
    - [First runbook](#first-runbook)
    - [Configurte environments](#configurte-environments)
    - [Create a Project](#create-a-project)
    - [Create a runbook](#create-a-runbook)
    - [Defining the runbook process for workers](#defining-the-runbook-process-for-workers)
    - [Running a Runbook](#running-a-runbook)
    - [Runbook specific variables](#runbook-specific-variables)
    - [Add runbook deployment targets](#add-runbook-deployment-targets)
    - [Defining the runbook process for targets (the essence)](#defining-the-runbook-process-for-targets-the-essence)
    - [Publishing a runbook](#publishing-a-runbook)
...
6. Scroll down and click ADD on the Run a Script file.
