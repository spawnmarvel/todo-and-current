...
- 📚 Zabbxi default and Ai 20h course [A project for maximizing all default monitoring](https://github.com/spawnmarvel/linux-and-azure/tree/main/azure-extra-linux-vm/zabbix_monitor_vms_snmp_default#ai-20h-course)), see if we have coverd 80%.
