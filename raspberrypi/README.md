...
- [Raspberry Pi IoT Chilli Monitoring](#raspberry-pi-iot-chilli-monitoring)
...
- [Raspberry Pi IoT](#raspberry-pi-iot)
  ...
  - [Preparing mira1 for Zigbee2MQTT](#preparing-mira1-for-zigbee2mqtt)
    ...
    - [Key Telemetry Output](#key-telemetry-output)
...
* Customizable Button Actions Assign different commands to single press, double press, and long press—control multiple devices or scenes effortlessly with one switch.
