...
Pro Tip: Change to table view and see if it is better

![tabl view](https://github.com/spawnmarvel/todo-and-current/blob/main/grafana_loki_alloy/images/tabl_view.png)

If you want to change it change the visualization drop down and save it

![save table](https://github.com/spawnmarvel/todo-and-current/blob/main/grafana_loki_alloy/images/save_table.png)

View it

![dash_table](https://github.com/spawnmarvel/todo-and-current/blob/main/grafana_loki_alloy/images/dash_table.png)
